...
enum {
	...
	LI, LC, SI, SC, PUSH, OR, XOR, AND, EQ, NE, \
	LT, GT, LE, GE, SHL, SHR, ADD, SUB, MUL, MOD, \
...
enum {
	Token, Hash, Name, Type, Class, Value, BType,\
	BClass, BValue, IdSize
};
